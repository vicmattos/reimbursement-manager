...
class ConfirmRequiredFieldsTests():

    def make_sut(self):
        return AddPurchaseController()

    def test_return_400_if_no_amount_is_provided(self):
        sut = self.make_sut()
    ...
    def test_return_400_if_no_currency_is_provided(self):
        sut = self.make_sut()
        http_request = HttpRequest(
            body = dict(
                amount = Decimal(10.00),
    ...
    def test_return_400_if_no_date_is_provided(self):
        sut = self.make_sut()
        http_request = HttpRequest(
            body = dict(
                amount = Decimal(10.00),
